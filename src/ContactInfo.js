    ...
    return (
        <div className="containerContactInfo" ref={props.reference}>
            <div className="imgContainer" id="leftContainerContact">
                <div className="containerStart">
                    <div className="contactRow" id="firstContactRow">
                        <img src={process.env.PUBLIC_URL + "/linkedin_logo.png"} height="30" className="contactLogo" />
                        <a className="contactLink" href="https://linkedin.com/in/MarcusTJensen" target="_blank">linkedin.com/in/MarcusTJensen</a>
                    </div>
                    <div className="contactRow">
                        <img src={process.env.PUBLIC_URL + "/github_logo.png"} height="30" className="contactLogo" />
            ...
            <div className="imgContainer">
                <div className="containerStart">
                    <div className="contactRow" id="firstContactRow">
                        <img src={process.env.PUBLIC_URL + "/email_logo.png"} height="30" className="contactLogo" />
                        <a className="contactLink">marcus.tveide.jensen@hotmail.com</a>
                    </div>
                    <div className="contactRow">
                        <img src={process.env.PUBLIC_URL + "/phone_logo.png"} height="35" className="contactLogo" />
